...
# IDs de precios (Asegúrate que coincidan con los de tu captura de Stripe)
ID_BUSINESS_ELITE = "price_1TDsW5Ra9HsPj8S8DjjHLUDV"
ID_BUSINESS_STARTER = "price_1TDsXsRa9HsPj8S83TKH7aNS"

# --- CONFIGURACIÓN DE PÁGINA ---
st.set_page_config(page_title="ZYNTH Enterprise IA", page_icon="💎", layout="wide")

# --- DISEÑO NEÓN LIMPIO (Sin cuadros vacíos) ---
st.markdown("""
<style>
...
if st.session_state.creditos <= 0:
    ...
    with col1:
        ...
        <div class="main-card starter-card">
            ...
            <h1 style="color: white;">$499 MXN</h1>
    ...
    with col2:
        ...
        <div class="main-card elite-card">
            ...
            <h1 style="color: white;">$3,500 MXN</h1>
...
# --- PANEL DE TRABAJO (SI HAY CRÉDITOS) ---
...
# (Aquí sigue tu función de procesamiento de IA de antes...)
